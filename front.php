...
<div class="main">
  <div class="left">
      ...
      <h1 class="w3-margin w3-jumbo">Health Care Chatbot is Here for you</h1>
      <p class="w3-xlarge"></p>
      <button class="w3-button w3-black w3-padding-large w3-large w3-margin-top" onclick="window.location.href='phpChatBot/index.php'">Chatbot</button>
      </header>
  </div>
  <div class="right">
