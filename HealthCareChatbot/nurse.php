...
<div class="container">
<center><h1>Request for Nurse</h1>
<form name="doctor" action="nurse.php" method="post"  >
...
<br>
<label for="prob"><b>How many days:-</b></label><br>
<input type="text" name="prob"  placeholder="Enter days" autocomplete="off" autofocus="autofocus">
<br><br>
<input type="submit" class="registerbtn" value="Submit" name="submit" onclick="myFunction()">
...
$con = mysqli_connect('localhost','root','admin');
  ...
  $gender = $_POST['gender'];
  $prob = $_POST['prob'];
  $sql = "insert into nurse(name,number,gender,prob) values('$name','$number','$gender','$prob')";
  if(!mysqli_query($con,$sql))
  {
    echo "Not inserted";
  }
  else{
    echo "<script>alert('Nurse Request form submitted sucessfully')</script>";
  }
}
?>
